...
export class DomainService {
  ...
  updateAgent(data: Map<string, string>, messages: string[], agent: Agent): Agent {
    ...
    if (data.has('p_agent_id')) {
      agent.p_agent_id = data.get('p_agent_id');
    }
    if (data.has('p_external_agent_id')) {
      agent.p_prefix = data.get('p_external_agent_id');
    }
    if (data.has('p_agent_first_name')) {
      agent.p_agent_first_name = data.get('p_agent_first_name');
    }
    if (data.has('p_agent_middle_name')) {
      agent.p_agent_middle_name = data.get('p_agent_middle_name');
    }
    if (data.has('p_agent_last_name')) {
      agent.p_agent_last_name = data.get('p_agent_last_name');
    }
    ...
    if (data.has('p_suffix')) {
      agent.p_suffix = data.get('p_suffix');
    }
    if (data.has('npn')) {
      agent.npn = data.get('npn');
    }
    if (data.has('dietary_or_personal_considerations')) {
      agent.dietary_or_personal_considerations = this.getYesNoValue(data.get('dietary_or_personal_considerations'));
    }
    if (data.has('dietary_consideration')) {
      agent.dietary_consideration = data.get('dietary_consideration');
    }
    if (data.has('dietary_consideration_type')) {
      agent.dietary_consideration_type = data.get('dietary_consideration_type');
    }
    if (data.has('upline')) {
      agent.upline = data.get('upline');
    }
    if (data.has('agencyName')) {
      agent.agencyName = data.get('agencyName');
    }
    if (data.has('manager_id')) {
      agent.manager_id = data.get('manager_id');
    }
    if (data.has('awb_site_id')) {
      agent.awb_site_id = data.get('awb_site_id');
    }

    if (data.has('prospect_referred_to')) {
      agent.prospect_referred_to = data.get('prospect_referred_to');
    }
    if (data.has('campaigns_user_name')) {
      agent.campaigns_user_name = data.get('campaigns_user_name');
    }
    if (data.has('campaigns_address')) {
      agent.campaigns_address = data.get('campaigns_address');
    }
    if (data.has('race')) {
      agent.race = data.get('race');
    }
    if (data.has('ethnicity')) {
      agent.ethnicity = data.get('ethnicity');
    }
    if (data.has('gender')) {
      agent.gender = data.get('gender');
    }
    if (data.has('primary_language')) {
      agent.primary_language = data.get('primary_language');
    }
    if (data.has('secondary_language')) {
      agent.secondary_language = data.get('secondary_language');
    }
    if (data.has('hobbies')) {
      agent.hobbies = data.get('hobbies');
    }
    if (data.has('p_tshirt_size')) {
      agent.p_tshirt_size = data.get('p_tshirt_size');
    }
    if (data.has('unisex_tshirt_size')) {
      agent.unisex_tshirt_size = data.get('unisex_tshirt_size');
    }
    if (data.has('favorite_destination')) {
      agent.favorite_destination = data.get('favorite_destination');
    }
    if (data.has('shoe_size')) {
      agent.shoe_size = data.get('shoe_size');
    }

    if (data.has('p_strategic_agent')) {
      agent.p_strategic_agent = this.getBoolean(data.get('p_strategic_agent'));
    }
    if (data.has('alliance_group_employee')) {
      agent.alliance_group_employee = this.getBoolean(data.get('alliance_group_employee'));
    }
    if (data.has('is_manager')) {
      agent.is_manager = this.getBoolean(data.get('is_manager'));
    }
    if (data.has('is_acb_user')) {
      agent.is_acb_user = this.getBoolean(data.get('is_acb_user'));
    }
    if (data.has('is_awb_user')) {
      agent.is_awb_user = this.getBoolean(data.get('is_awb_user'));
    }

    if (data.has('prospect_referred_to_date')) {
      agent.prospect_referred_to_date = new Date(data.get('prospect_referred_to_date'));
    }
    if (data.has('campaigns_user_since')) {
      agent.campaigns_user_since = new Date(data.get('campaigns_user_since'));
    }
    if (data.has('dob')) {
      agent.dob = new Date(data.get('dob'));
    }
    ...
    if (data.has('agency_approve_deny_reason')) {
      agent.agency_approve_deny_reason += agent.agency_approve_deny_reason
        ...
        : data.get('agency_approve_deny_reason');
    }
